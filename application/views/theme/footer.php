<footer class="footer">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="https://syahrulramadhan.id" target="_blank">Himpunan Mahasiswa Teknologi Informasi</a> </p>
                        </p>
                    </div>
                </div>
            </div>
